...
export const darkitPoimandres = {
	name: 'Darkit Poimandres',
	colors: {
		...
		'list.focusBackground': colors.darkBlue[800],
		...
		'menubar.selectionForeground': colors.darkBlue[100],
		'menubar.selectionBorder': colors.transparent,
		'menu.background': bg,
		'menu.foreground': colors.darkBlue[100],
		'menu.selectionBackground': colors.darkBlue[600],
		'menu.selectionForeground': colors.darkBlue[50],
		...
		'input.background': colors.darkBlue[800],
		...
		'panel.background': bg,
		'panel.border': colors.darkBlue[800],
		...
		'terminal.foreground': colors.darkBlue[50],
		...
		'terminal.ansiBrightCyan': colors.cyan[200],
		...
		'notifications.background': colors.darkBlue[800],
		...
		'editor.foreground': colors.slate[100],
		...
		'editor.inactiveSelectionBackground': colors.darkBlue[800],
		...
		'peekViewEditor.background': colors.darkBlue[800],
		'peekView.border': colors.darkBlue[900],
		'peekViewResult.background': colors.darkBlue[800],
		'peekViewTitle.background': colors.darkBlue[800],
	...
	tokenColors: [
		{
			...
			scope: ['comment'],
			settings: {
				foreground: colors.darkBlue[500],
			},
		},
		{
			name: 'Variable',
