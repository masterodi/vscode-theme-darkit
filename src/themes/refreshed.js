...
const refreshedTheme = {
	...
	tokenColors: createTokenColors({
		...
		functions: { color: colors.roseRed[300] },
		classes: { color: colors.indigo[400] },
		tags: { color: colors.indigo[300] },
		tagsPunctuation: { color: colors.indigo[400] },
		htmlAttributes: { color: colors.washedBlue[200] },
		htmlIds: { color: colors.pink[400] },
		primitives: { color: colors.aquamarine[400] },
		constants: { color: colors.aquamarine[400] },
		numbers: { color: colors.cyan[200] },
		objectProperties: { color: colors.white },
		operators: { color: colors.aquamarine[400] },
	}),
