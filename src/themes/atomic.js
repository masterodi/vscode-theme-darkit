...
const atomicTheme = {
	...
	colors: {
		...
		errorForeground: colors.pink[500],
		...
		'toolbar.activeBackground': bg.highlightExtra,
		'toolbar.hoverBackground': bg.highlight,
		...
		'button.background': bg.highlightExtra,
		'button.foreground': text.highlight,
		'button.secondaryBackground': accent,
		'button.secondaryForeground': text.onAccent,
