...
const newTheme = {
	...
	tokenColors: createTokenColors({
		...
		strings: { color: '#ff9ebe' },
		regex: { color: '#ff72a0' },
		keywords: { color: '#9ea4ff' },
		storage: { color: '#9ea4ff' },
		functions: { color: '#a6cdff' },
		functionParameters: { color: Color(foreground).lighten(0.4).hex() },
		classes: { color: '#a6f7f9' },
		tags: { color: '#a6f7f9' },
		tagsPunctuation: { color: Color(foreground).lighten(0.25).hex() },
		htmlAttributes: { color: '#9bbff2' },
		htmlIds: { color: '#9bf2b9' },
		primitives: { color: '#ff9ee7' },
		constants: { color: '#fb7185' },
		numbers: { color: '#8cc3ff' },
		objectProperties: { color: '#5eead4' },
		operators: { color: '#a1c1ff' },
		readWriteAliases: { color: '#95dddb' },
	}),
