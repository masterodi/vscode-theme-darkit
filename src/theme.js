...
const theme = {
    ...
    tokenColors: [
        ...
        },
        {
            name: 'Keyword',
            scope: ['keyword'],
            settings: { foreground: colors.debianRed[400] },
        },
        {
        ...
        },
        {
            ...
            settings: { foreground: colors.yaleBlue[300] },
        },
        {
            name: 'Keyword Other Unit',
            scope: ['keyword.other.unit'],
            settings: { foreground: colors.tealishGreen[300] },
        },
        {
            name: 'Storage',
            scope: ['storage'],
        ...
        },
        {
            ...
            settings: { foreground: colors.blizzardBlue[400] },
        },
        {
        ...
        },
        {
            ...
            settings: { foreground: colors.primary[300] },
        },
        {
            name: 'This, Super, Self',
            scope: [
                'variable.language.this',
                'variable.language.super',
                'variable.parameter.function.language.special.self',
            ],
            settings: { foreground: colors.debianRed[300] },
        },
        {
            name: 'String',
            scope: ['string'],
        ...
        {
            name: 'Entity Name Function, Support Function, Meta Function-Call Generic',
            scope: [
        ...
        },
        {
            ...
            settings: { foreground: colors.ferrariRed[300] },
        },
        {
        ...
        },
        {
            name: 'Meta Tag',
            scope: ['meta.tag'],
            settings: { foreground: colors.ferrariRed[400] },
        },
        {
            name: 'Underline',
            scope: ['underline'],
        ...
        {
            name: 'None | Meta Jsx Children',
            scope: ['none', 'meta.jsx.children'],
            settings: { foreground: colors.neutral[200] },
        },
        {
            name: 'Invalid Deprecated',
            scope: ['invalid.deprecated'],
            settings: { foreground: colors.error[400], background: '#E0C285' },
        },
        {
